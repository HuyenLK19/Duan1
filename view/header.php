                            ...
                            <div class="nav-panel__row">
                                ...
                                <div class="nav-panel__nav-links nav-links">
                                    <ul class="nav-links__list">
                                        ...
                                        <li class="nav-links__item nav-links__item--has-submenu"><a class="nav-links__item-link" href="index.php?act=thongtintk">
                                                <div class="nav-links__item-body">Quản lý tài khoản</div>
                                            </a>
                                        </li>
