                        ...
                        <div class="search search--location--header">
                            <div class="search__body">
                                <form class="search__form" action="#"><select class="search__categories" aria-label="Category">
                                    ...
                                    </select> <input class="search__input" name="search" placeholder="Tìm kiếm hơn 1000 sản phẩm" aria-label="Site search" type="text" autocomplete="off"> <button class="search__button search__button--type--submit" type="submit"><svg width="20px" height="20px">
                                        ...
                                        <div class="indicator__dropdown">
                                            ...
                                            <div class="dropcart dropcart--style--dropdown">
                                                <div class="dropcart__body">
                                                    ...
                                                    <div class="dropcart__buttons"><a class="btn btn-secondary" href="index.php?act=cart">Xem giỏ hàng</a> <a class="btn btn-primary" href="index.php?act=checkout">Đơn hàng</a></div>
                                                </div>
                                            </div><!-- .dropcart / end -->
                                        </div>
                                    </div>
