        ...
        <div class="page-header__container container">
            <div class="page-header__breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Trang chủ</a> <svg class="breadcrumb-arrow"
                                ...
                                <div class="products-list__item">
                                    <div class="product-card product-card--hidden-actions"><button
                                        ...
                                        <div class="product-card__info">
                                            <div class="product-card__name"><a href="product.html">Áo khoác gió</a>
                                            </div>
                                        ...
                                        <div class="product-card__actions">
                                            ...
                                            <div class="product-card__prices">234.000 VND</div>
                                                ...
                                                <ul class="filter-categories__list">
                                                    <li class="filter-categories__item filter-categories__item--parent">
                                                        <svg class="filter-categories__arrow" width="6px" height="9px">
                                                            <use
                                                                xlink:href="css/images/sprite.svg#arrow-rounded-left-6x9">
                                                            </use>
                                                    ...
                                                    <li class="filter-categories-alt__item filter-categories-alt__item--open filter-categories-alt__item--current"
                                                        ...
                                                        <div class="filter-categories-alt__children"
                                                            ...
                                                            <ul
                                                                class="filter-categories-alt__list filter-categories-alt__list--level--2">
                                                                <li class="filter-categories-alt__item"
                                                                    data-collapse-item><a href="#">Screwdrivers</a></li>
                                                                <li class="filter-categories-alt__item filter-categories-alt__item--current"
                                                                    ...
                                                                    <div class="filter-categories-alt__children"
                                                                        ...
                                                                        <ul
                                                                            ...
                                                                            <li class="filter-categories-alt__item"
                                                                                data-collapse-item><a href="#">Power
                                                                                    Saws</a></li>
                                                                            <li class="filter-categories-alt__item"
                                                                            ...
                                                                            <li class="filter-categories-alt__item"
                                                                                data-collapse-item><a href="#">Chain
                                                                                    Saws</a></li>
                                                                            <li class="filter-categories-alt__item"
                                                                                data-collapse-item><a
                                                                            ...
                                                                            <li class="filter-categories-alt__item"
                                                                                data-collapse-item><a href="#">Other</a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </li>
                                                                ...
                                                                <li class="filter-categories-alt__item"
                                                                    data-collapse-item><a href="#">Multitools</a></li>
                                                                <li class="filter-categories-alt__item"
                                                ...
                                                <div class="filter-list__list"><label class="filter-list__item"><span
                                                    ...
                                                    <label class="filter-list__item filter-list__item--disabled"><span
                                                            class="filter-list__input input-radio"><span
                                                                class="input-radio__body"><input
                                                                    class="input-radio__input" name="filter_radio"
                                                                    type="radio" checked="checked" disabled="disabled">
                                            ...
                                            <div class="filter-color">
                                                <div class="filter-color__list"><label class="filter-color__item"><span
                                                            ...
                                                            style="color: #fff;"><label
                                                                ...
                                                                <span class="input-check-color__box"></span> <svg
