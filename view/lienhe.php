...
<!-- Mirrored from stroyka.html.themeforest.scompiler.ru/themes/default-ltr/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Nov 2023 09:43:41 GMT -->
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6 pb-4 pb-lg-0">
                                        ...
                                        <div class="contact-us__address">
                                            ...
                                            <p><strong>Giờ mở cửa</strong><br>Thứ Hai đến Thứ Sáu: 8 giờ sáng - 8 giờ<br>tối Thứ Bảy: 8 giờ sáng - 6 giờ<br>chiều Chủ Nhật: 10 giờ sáng - 4 giờ chiều</p>
                                            <p><strong>Nhận xét</strong><br>về nhu cầu của khách hàng, khách hàng cần phải được tuân theo. Cuộc trò chuyện của tôi cuốn hút tôi, tôi không cần thời gian, không có giới hạn. Khách hàng rất quan trọng, khách hàng sẽ được khách hàng theo đuổi.</p>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <h4 class="contact-us__header card-title">Để lại cho chúng tôi một tin nhắn</h4>
                                        <form>
                                            <div class="form-row">
                                                <div class="form-group col-md-6"><label for="form-name">Tên của bạn</label> <input type="text" id="form-name" class="form-control" placeholder="Tên của bạn"></div>
                                                <div class="form-group col-md-6"><label for="form-email">Email</label> <input type="email" id="form-email" class="form-control" placeholder="Địa chỉ Email "></div>
                                            </div>
                                            <div class="form-group"><label for="form-subject">Chủ thể</label> <input type="text" id="form-subject" class="form-control" placeholder=""></div>
                                            <div class="form-group"><label for="form-message">Tin nhắn</label> <textarea id="form-message" class="form-control" rows="4"></textarea></div><button type="submit" class="btn btn-primary">Gửi Tin nhắn</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
