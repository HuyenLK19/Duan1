                    ...
                    <div class="page-header__breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Áo gió
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="product product--layout--standard" data-layout="standard">
                        <div class="product__content"><!-- .product__gallery -->
                            <div class="product__gallery">
                                ...
                                --> <a href="css/images/products/product-16.jpg" data-width="700" data-height="700"
                                                    class="product-image__body" target="_blank"><img
                                                        class="product-image__img" src="css/images/products/anh1.webp"
                                                        alt=""></a></div>
                                            <div class="product-image product-image--location--gallery"><!--
                                The data-width and data-height attributes must contain the size of a larger version
                                of the product image.
                                ...
                                --> <a href="css/images/products/product-16-4.jpg" data-width="700" data-height="700"
                                    ...
                                    <div class="product-gallery__carousel">
                                        <div class="owl-carousel" id="product-carousel"><a
                                                href="css/images/products/product-16.jpg"
                                                class="product-image product-gallery__carousel-item">
                                                <div class="product-image__body"><img
                                                        class="product-image__img product-gallery__carousel-image"
                                                        src="css/images/products/anh1.webp" alt=""></div>
                                            </a><a href="css/images/products/product-16-1.jpg"
                                                class="product-image product-gallery__carousel-item">
                                                <div class="product-image__body"><img
                                                        class="product-image__img product-gallery__carousel-image"
                                                        src="css/images/products/anh1.webp" alt=""></div>
                                            </a><a href="css/images/products/product-16-2.jpg"
                                                class="product-image product-gallery__carousel-item">
                                                <div class="product-image__body"><img
                                                        class="product-image__img product-gallery__carousel-image"
                                                        src="css/images/products/anh1.webp" alt=""></div>
                                            </a><a href="css/images/products/product-16-3.jpg"
                                                class="product-image product-gallery__carousel-item">
                                                <div class="product-image__body"><img
                                                        class="product-image__img product-gallery__carousel-image"
                                                        src="css/images/products/anh1.webp" alt=""></div>
                                            </a><a href="css/images/products/anh1.webp"
                                                class="product-image product-gallery__carousel-item">
                                                <div class="product-image__body"><img
                                                        class="product-image__img product-gallery__carousel-image"
                                                        src="css/images/products/anh1.webp" alt=""></div>
                            ...
                            <div class="product__info">
                                ...
                                <h1 class="product__name">Áo gió</h1>
                                ...
                                <div class="product__description">Áo có chất liệu nỉ co giãn, giữ ấm, bề mặt vải mịn cùng màu sắc thanh lịch có thể mặc đi làm, đi chơi hoặc ở nhà vào mùa đông</div>
                            ...
                            <div class="product__sidebar">
                                ...
                                <form class="product__options">
                                    <div class="form-group product__option"><label
                                            class="product__option-label">Màu sắc</label>
                        ...
                        <div class="product-tabs__content">
                            <div class="product-tabs__pane product-tabs__pane--active" id="tab-description">
                                <div class="typography">
                                    ...
                                    <p>Chất liệu lụa mềm mịn, thành phần: 100% Polyester

Vải có hiệu ứng bóng nhẹ tạo lên sự sang trọng cho sản phẩm

Thiết kế dáng suông với đường may tinh tế và tỉ mỉ khiến các chi tiết tạo nên chiếc áo thông minh

Có thể mặc theo hai kiểu khác nhau buộc trước ngực hoặc lệch một bên

Dễ dàng kết hợp với nhiều item như quần âu, chân váy và phụ kiện khác để mặc đi làm, đi chơi, dạo phố
                                ...
                                <div class="block-products-carousel__cell">
                                    <div class="product-card product-card--hidden-actions"><button
                                        ...
                                        <div class="product-card__info">
                                            <div class="product-card__name"><a href="product.html">Quần jean</a>
                                            </div>
                            ...
                            <div class="block-products-carousel__column">
                                <div class="block-products-carousel__cell">
                                    <div class="product-card product-card--hidden-actions"><button
                                        ...
                                        <div class="product-card__image product-image"><a href="product.html"
                                                class="product-image__body"><img class="product-image__img"
                                                    src="css/images/products/anh5.webp" alt=""></a></div>
                                        <div class="product-card__info">
                                            <div class="product-card__name"><a href="product.html">Quần jean</a>
                                            </div>
                                            <div class="product-card__rating">
