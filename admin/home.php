<div class="row">
    <div class="col-12">
        <div>
            <h4 class="header-title mb-3">Trang chủ</h4>
        </div>
    </div>
</div>
<!-- end row -->
                ...
                <div class="row">
                    <div class="col-xl-3 col-sm-6 widget-inline-box">
                        <div class="text-center p-3">
                            <h2 class="mt-2"><i class="text-primary mdi mdi-access-point-network mr-2"></i> <b>8954</b>
                            </h2>
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="text-center p-3">
                            ...
                            <p class="text-muted mb-0">Tổng số lượt bình luận</p>
                        </div>
                    </div>
